...
class APIEndpoint(object):
    """
    Represents an API endpoint for himydata, containing common patterns
    for CRUD operations.
    """
    ...
    def __init__(self, api, endpoint=None, cls=None):
        ...
        Args:
            api - himydata.client - The authenticated REST client
            endpoint - str - The URL path to the resource endpoint
            cls - himydata.models.Model - The Class to use when parsing results
        """
        self.api = api
    ...
    def get(self,
        ...
        Args:
            cls - himydata.models.Model - The resource class
            ...
            resource_cls - cls - A class to use for parsing, if different than
                the base resource
            single_resource - bool - An override to tell himydata that even
    ...
    def post(self, resource):
        ...
        Args:
            resource - himydata.models.Model - The resource instance
